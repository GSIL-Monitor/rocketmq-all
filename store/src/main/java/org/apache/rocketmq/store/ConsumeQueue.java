 ...
 * 每个 consumequeue 文件的名称 fileName，名字长度为 20 位，左边补零，剩余为起始偏量；
 * 比如 00000000000000000000 代表了第一个文件，起始偏移量为 0，文件大小为 600W，
 * 当第一个文件满之后创建的第二个文件的名字为00000000000006000000，起始偏移量为6000000，
 * 以此类推，第三个文件名字为00000000000012000000，起始偏移量12000000。消息存储的时候会顺序写入文件，当文件满了，写入下一个文件。
 */
