...
public class MQClientInstance {
    ...
    /**
     * 服务状态 : CREATE_JUST RUNNING SHUTDOWN_ALREADY START_FAILED
     */
    ...
    private void startScheduledTask() {
        ...
        /**
         * getPollNameServerInterval 配置的时间 更新 namesrv
         */
        this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
        ...
        /**
         * 配置的getHeartbeatBrokerInterval时间 清除下线broker和发送心跳
         */
        this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
    ...
    private void sendHeartbeatToAllBroker() {
        ...
        //若 ConsumerData 集合和 ProducerData 集合都为空，说明没有 consumer或 produer，则不发送心跳信息
        ...
        /**
         * 若不是都为空，则遍历 MQClientInstance.brokerAddrTable 列表，向每个 Broker 地址发送请求码为 HEART_BEAT 的心跳消息，
        ...
        if (!this.brokerAddrTable.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                String brokerName = entry.getKey();
                HashMap<Long, String> oneTable = entry.getValue();
                // broker不为空 oneTable<brokerId,address>
                if (oneTable != null) {
        ...
        try {
            ...
            if (this.lockNamesrv.tryLock(LOCK_TIMEOUT_MILLIS, TimeUnit.MILLISECONDS)) {
                try {
                    ...
                    //一个是获取默认topic的配置信息，一个是获取指定topic的配置信息
                    //获取默认的topic信息 --> GET_ROUTEINTO_BY_TOPIC
                    if (isDefault && defaultMQProducer != null) {
                        ...
                        //获取指定的topic信息 --> GET_ROUTEINTO_BY_TOPIC
    ...
    private HeartbeatData prepareHeartbeatData() {
        //初始化 HeartbeatData 对象，将该 Producer 或 Consumer 的 ClientID 赋值给 HeartbeatData 对象的 clientID 变量；
        ...
        // Consumer
        //遍历 MQClientInstance.consumerTable，根据每个 MQConsumerInner 对象的值初始化ConsumerData 对象和ProducerData对象
    ...
    /**
     * 循环遍历每个消费组获取 MQConsumeInner对象（其实就是DefaultMQPushConsumerImpl或DefaultMQPullConsumerImpl对象），
     * 并执行其doRebalance方法
     */
