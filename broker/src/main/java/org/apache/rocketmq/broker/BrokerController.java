...
public class BrokerController {
    ...
    //启动 ClientHousekeepingService 服务，在启动过程中设置定时任务
    ...
    private RemotingServer fastRemotingServer; //设置vipChannel,port-2
    ...
    public BrokerController(
        ...
        // 初始化 ConsumerOffsetManager 读取 consumerOffset.json
        this.consumerOffsetManager = new ConsumerOffsetManager(this);
        // 初始化 TopicConfigManager ,读取 topicConfig.json
        ...
        // 初始化 SubscriptionGroupManager ,读取 subscriptionGroup.json
    ...
    public boolean initialize() throws CloneNotSupportedException {
        ...
        if (result) {
            //启动 Broker 的 Netty 服务端 NettyRemotingServer。监听消费者或生产者发起的请求信息并处理；
            ...
            final long period = 1000 * 60 * 60 * 24; //每24小时记录一次
            ...
            // 每1分钟 getMessageStore().dispatchBehindBytes() 一次
            this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
