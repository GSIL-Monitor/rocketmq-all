...
public class SendMessageProcessor extends AbstractSendMessageProcessor implements NettyRequestProcessor {
    ...
    public RemotingCommand processRequest(ChannelHandlerContext ctx,
        ...
        switch (request.getCode()) {
            ...
            default:
                //解码收到的消息，并构建 SendMessageRequestHeader 对象
                ...
                //若 SendMessageProcessor 处理器设置了发送消息的钩子，则调用该钩子类的
                ...
                if (requestHeader.isBatch()) {
                    ...
                    //调用 SendMessageProcessor.sendMessage方法处理的消息并返回处理结果 PutMessageResult 对象；
                    //下一步: 根据上一步返回的 PutMessageResult 对象中的status，设置相应的消息代码
    ...
    private RemotingCommand sendMessage(final ChannelHandlerContext ctx,
        ...
        /**
         * Broker端首先客户发送消息请求后，判断消息类型，如果是事务消息，则调用TransactionalMessageService#prepareMessage方法，
