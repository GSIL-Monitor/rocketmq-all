...
public class ClientManageProcessor implements NettyRequestProcessor {
    ...
    public RemotingCommand heartBeat(ChannelHandlerContext ctx, RemotingCommand request) {
        ...
        //解码接受消息，生成 HeartbeatData 对象；
        HeartbeatData heartbeatData = HeartbeatData.decode(request.getBody(), HeartbeatData.class);

        //根据链接的 Channel、 ClientID 等信息初始化 ClientChannelInfo 对象
        ...
        //若 HeartbeatData 对象中的 ConsumerData 集合有数据，则进行 Consumer注册
        ...
        //若 HeartbeatData 对象中的 ProducerData 集合有数据，则对每个ProducerData进行 Producer 注册
