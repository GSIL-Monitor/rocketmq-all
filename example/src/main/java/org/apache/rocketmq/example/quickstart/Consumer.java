...
public class Consumer {
     ...
     * 1，用consumerGroup为参数初始化DefaultMQPushConsumer 对象，默认初始化MessageQueue分配策略
     *  AllocateMessageQueueAveragely 赋值给DefaultMQPushConsumer.allocateMessageQueueStrategy 变量；
     * 2，设置NameServer值
    ...
    public static void main(String[] args) throws InterruptedException, MQClientException {
        ...
        // 通过 sql 查询
        //consumer.subscribe("topic", MessageSelector.bySql("a between 1 and 2"));
        /*
